//I"ve used https://restcountries.eu/ API but its server went down 
//Countries available in NEWSAPI
export const availableInNewsApi = [
    "ae",
    "ar",
    "at",
    "au",
...
const countriesAll = [
    ...
    { name_pl: "Korea Południowa", name_en: "South Korea", code: "KR" },
    { name_pl: "Korea Północna", name_en: "North Korea", code: "KP" },
    { name_pl: "Kostaryka", name_en: "Costa Rica", code: "CR" },
    { name_pl: "Kuba", name_en: "Cuba", code: "CU" },
    { name_pl: "Kuwejt", name_en: "Kuwait", code: "KW" },
    { name_pl: "Laos", name_en: "Lao Peoples Democratic Republic", code: "LA" },
    ...
    { name_pl: "Tajwan", name_en: "Taiwan", code: "TW" },
    ...
    { name_pl: "Wenezuela", name_en: "Venezuela", code: "VE" },
...
//List of countries available in NEWSAPI with flags
export const countriesList = countriesAll.filter((country) => 
    availableInNewsApi.includes(country.code.toLowerCase())).map((country) => {
        return {
            code: country.code,
